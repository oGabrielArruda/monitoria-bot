...
horarios = {
    'Nicolas': {
        0: [(time(16,35), time(17,25))], 
        1: [(time(7,30), time(8,20)), (time(13,00), time(13,50))],
        2: [(time(13,00), time(13,50)), (time(18,15), time(19,00))],        
        3: [(time(11,5), time(11,55))],
        4: [(time(8,20), time(11,55)), (time(13,00), time(14,40))],
        5: [(time(9,00), time(11,5))]
    },
    'Nouani': {
        0: [(time(13,00), time(13,50)), (time(16,35), time(17,25))], 
        1: [(time(18,15), time(19,00))],
        2: [(time(10,15), time(11,55))],
        3: [(time(10,15), time(11,5))],
        4: [(time(8,20), time(11,55)), (time(18,15), time(20,20))],
        5: [(time(10,00), time(12,00))]
    },
    'Gabriel': {
        0: [(time(13,00), time(13,50)), (time(16,35), time(17,25))],        
        1: [(time(7,30), time(8,20)), (time(13,00), time(13,50)), (time(18,15), time(19,00))],
        2: [(time(18,15), time(19,00))],
        3: [(time(10,15), time(11,5))],
        4: [(time(8,20), time(11,55)), (time(13,00), time(14,40)), (time(19,00), time(20,20))]
    },
    'Lucas': {
        0: [(time(16,35), time(19,40))],
        1: [(time(17,25), time(19,00))],
        2: [(time(17,25), time(19,00))],
        3: [(time(17,25), time(19,00))],
        4: [(time(16,35), time(18,15))],
        5: [(time(9,00), time(11,00))]
    },
    'Isabela': {
        0: [(time(8,20), time(10,00)), (time(18,15), time(19,40))],
        1: [(time(7,30), time(9,10)), (time(13,00), time(13,50))],
        2: [(time(18,15), time(19,00))],
        4: [(time(8,20), time(12,00)),(time(18,15), time(20,30))]
    }
}
